...
**免責聲明：** 本項目與任何地產代理公司均無從屬、授權、背書或合作關係，純屬第三方工具。使用者須自行確認其使用方式符合相關網站之使用條款、授權範圍及適用法律。
...
本系統僅供個人進行本地市場觀察與分析之用。使用時應控制請求頻率、保留來源連結，並嚴格遵守各網站之服務條款。請勿將 `first_delisted_at` 視為真實成交時間。系統預設不採集、不儲存經紀人姓名及電話等個人資料，亦不持久化來源 API 或網頁之原始數據（Payload）。
