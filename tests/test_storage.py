...
class StorageTests(unittest.TestCase):
    ...
    def test_scan_task_from_data_url(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            summary = (task_dir / "exports" / "summary.md").read_text(encoding="utf-8")
            self.assertIn("来源链接", summary)
            self.assertIn("[中原地产](https://hk.centanet.com/findproperty/zh-cn/detail/foo_ABC123?theme=rent)", summary)
